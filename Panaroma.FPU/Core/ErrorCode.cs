...
namespace ServiceProject.Service
{
    public class ErrorCode
    {
        ...
        public static ErrorCode GetErrorExplanation(string errorCode)//arif ekledi beğenmedim değiştirelecek.
        {
            if (errorList == null)
            {
                ...
                errorList.Add(new ErrorCode { errorCode = "E100", errorMessage = "Fiscal mode flag error in FM", errorExplanation = "Mali Yazılım Zaman Aşımına uğradı" });
                ...
                errorList.Add(new ErrorCode { errorCode = "E1453", errorMessage = "FİŞ YAZICISI İLE İLGİLİ BİR SORUN GÖRÜNÜYOR.. KAĞIT RULOSU TAM YERLEŞTİRİLMEMİŞ VEYA FİŞ YAZICISI ÇALIŞMADIĞI İÇİN HERHANGİ BİR İŞLEM YAPMAYACAKTIR.", errorExplanation = "İşlem Başarısız" });
            }
